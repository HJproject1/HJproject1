								...
								<td>
									...
									<div class="pay_btn_wrap">
										<div class="pay_btn_box">
											<button type="submit" onclick="location.href='FcController?id=<%=id%>&command=orderHistory'"><img src="https://www.fcseoul.com/resources/shop/_img/btn/btn_okey.gif"/></button>
 										</div>
									</div>
								</td>
							</tr>
