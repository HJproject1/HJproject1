...
<head>
	...
	<link rel="stylesheet" href="css/clubintro3.css">
	...
	<section class="bannertop">
		...
		<div class="mainSection">
			...
			<div class="emblem">
				<div class="el">
					<figure>
						<img alt="" src="https://www.fcseoul.com/resources/front/images/sub/club/img_club_emblem01.jpg">
						<figcaption>국문 상하조합</figcaption>
					</figure>
				</div>
				<div class="er">
					<figure>
						<img alt="" src="https://www.fcseoul.com/resources/front/images/sub/club/img_club_emblem02.jpg">
						<figcaption>국문 좌우조합</figcaption>
					</figure>
				</div>
			</div>
			<div class="emtext">
				<strong>
					<span>엠블럼은 2002년 월드컵의 열기와 함성,</span> <br/>
					그리고 구단역사를 계승하고 서울시민과 함께 발전하는 명문구단을 상징적으로 디자인한 것입니다.
				</strong>
				<p>기본 외형은 기존의 서구적 방패형 또는 원형 엠블럼들과는 달리 홈구장으로 사용하는 서울 월드컵 경기장의 8각
						방패연 지붕 이미지를 살려 다른 구단들과의 차별성과 함께 한국 전통에 대한 상징성을 부각하였으며, 그 안에 축구공과
						함께 풍요와 정열을 상징하는 불타는 태양의 이미지를 한국적 문양으로 재구성, FC서울의 수호신으로 형상화 하였습니다.
				</p>
				<p>또한, 글로벌 명문구단으로의 도약을 위해 영문 구단명 ‘FC SEOUL’과 함께 방패연이 하늘 높이 떠 있는
						모습을 시각적 라인으로 형상화하였으며 구단 창단연도인 1983년과 서울 연고지 복귀 원년인 2004년을 표현하여 한국
						프로축구와 함께 해온 구단의 역사를 분명하게 나타내었습니다.
				</p>
				<p>엠블럼에 쓰인 3가지 색은 정열과 도전을 상징하는 적색과 풍요와 영광을 상징하는 금색, 세련미와 강인함을
						상징하는 검정색을 조화롭게 적응하여 한국적(전통적)이며 국제적 감각이 느껴지도록 하였습니다.
				</p>
				<div class="down">
			...
			<div class="emblem">
				<div class="el">
					<figure>
						<img alt="" src="https://www.fcseoul.com/resources/front/images/sub/club/img_40th_emblem01.jpg">
						<figcaption>40주년 기념 엠블럼</figcaption>
					</figure>
				</div>
				<div class="er">
					<figure>
						<img alt="" src="https://www.fcseoul.com/resources/front/images/sub/club/img_40th_emblem02.jpg">
						<figcaption>40주년 기념 로고</figcaption>
					</figure>
				</div>
			</div>
			<div class="emtext">
				<strong>
					<span class="black">1983 · 2023</span> <br/>
					40TH ANNIVERSARY
				</strong>
				<p>
			...
			<div class="emblem last">
				<div class="e " >
					<figure>
						<img alt="" src="	https://www.fcseoul.com/resources/front/images/sub/club/logo_emblem01.jpg">
						<figcaption>국문타입</figcaption>
					</figure>
				</div>
				<div class="e elast">
					<figure>
						<img alt="" src="https://www.fcseoul.com/resources/front/images/sub/club/logo_emblem02.jpg">
						<figcaption>영문타입</figcaption>
					</figure>
				</div>
			</div>
	</div>
