...
<%
	...
	NewsDTO selectNews = (NewsDTO)request.getAttribute("selectNews");
...
<head>
	...
	<link rel="stylesheet" href="css/NewsDetailV2.css">
	...
	$("document").ready(function() {  
		...
		$(function(){
			...
			$(".title").click(function() {
				...
				location.href = "FcController?command=newsDetail&bno=" + bno;
			});
    	...
    	function alert(){
    		if(!confirm("삭제하시겠습니까?")){
    			...
    			location.href = "NewsDeleteAction.jsp?seq="+<%=Integer.parseInt(request.getParameter("seq"))%>;
    		}
    	}
    	function paging(it) {
    	...
    	function backToList(){
  		  const URLSearch = new URLSearchParams(location.search);
  		  URLSearch.delete('seq');
  		  URLSearch.set('command',"news2");
  		  const newParam = URLSearch.toString();
   		  window.open(location.pathname + '?' + newParam, '_self');
    	}
    	function ready() {
			...
			<section class = "maincontent">
				<div class = "top">
					<div class="txtWrap">
			            ...
			            <p class="txt"><%=selectNews.getTitle()%></p>
						<a onclick = "alert()" class = "bg">삭제</a>
			            <p>
			              <span class="date"><%=selectNews.getWritedate() %></span>
			            </p>
		         	 </div>
				</div>
				<div class = "middle">
					<p><img src="<%=selectNews.getImage()%>"><br style="clear:both;">&nbsp;</p>
					<p class="" style="line-height: 150%; margin: 0cm; text-align: justify; font-size: 10pt; font-family: &quot;Times New Roman&quot;, serif;"><span style="font-size: 11pt; font-family: &quot;맑은 고딕&quot;;"><span lang="EN-US"><%=selectNews.getContent().isEmpty()?"": selectNews.getContent()%></p>
				</div>
				<div class = "btnWrap">
					<a class="bg" onclick = "backToList()">목록</a>
				</div>
				<div class = "ntWrap">
					<div class = "plWrap">
					<ul>
