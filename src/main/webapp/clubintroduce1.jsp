...
<head>
	...
	<link rel="stylesheet" href="css/clubintro1.css">
...
<body>
	...
	<section class="bannertop">
		...
		<div class="mainSection">
			...
			<img alt="" src="https://www.fcseoul.com/resources/front/images/sub/club/img_ceo_greeing.jpg">
			<div class="text">
				<strong>아낌없는 사랑으로 FC서울을 가득 채워주시는 팬 여러분, 그리고 서울 시민 여러분 안녕하십니까?</strong>
				<p>언제 어디서나 FC서울이 또렷이 빛날 수 있게 힘을 더 해 주시는 팬 여러분께 진심으로 감사의 마음을 전합니다.</p>
				<p>코로나로 인해 열정적인 응원과 함성이 제한 받는 어려움 가운데서도, 팬 여러분들의 뜨거운 박수소리는 FC서울의 심장을 강하게 두드렸습니다.</p>
				<p>FC서울이 더 열심히 뛰어야 할 이유는 분명합니다. 팬 여러분들이 함께 해 주시기에 더욱 하나로 뭉쳐 힘차게 달려가겠습니다.</p>
				<p>무엇보다 팬 여러분들의 목소리 하나하나 귀 기울이며 소통에 힘쓰겠습니다. 다시금 FC서울을 통해 재미와 감동을 선물 받으실 수 있게 하겠습니다.</p>
				<p>서울월드컵경기장에는 팬 여러분들의 열정적인 응원과 함성소리로 가득 찰 것입니다. 이제 더 많은 팬 분들을 모시고 FC서울은 더 좋은 모습으로 보답할 것입니다.</p>
				<p>팬 여러분들의 열정적인 응원과 함성이 가득할 ‘그날’을 위해, FC서울 구성원 모두는 최선의 준비와 노력을 다하겠습니다.</p>
				<p>감사합니다.</p>
			</div>
		</div>
			</div>
