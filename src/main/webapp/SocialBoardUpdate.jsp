...
<%
    	SocialBoardDto detailInfo = (SocialBoardDto)request.getAttribute("detailInfo");
...
<head>
	...
	<link rel="stylesheet" href="css/SocialBoardWrite.css">
		...
		<div class="mainSection">
			...
			<div class="writewrap">
				<form action="FcController" id="firm">
					<input type="hidden" name="bno" value="<%=detailInfo.getBno() %>"/>
					...
					<table>
						<tr>
							<th>이름</th>
							<td>
								<span><%=detailInfo.getNickName() %></span>
						...
						<tr>
							<th>등록일</th>
							<td>
								<span><%=detailInfo.getwDate() %></span>
							</td>
						</tr>
						<tr>
							<th>제목</th>
							<td>
								<input type="text" name="title" value="<%=detailInfo.getTitle()%>">
								<p>* 최대 50자까지 등록 할 수 있습니다.</p>
							</td>
						</tr>
						<tr>
							<th>내용</th>
							<td>
								<textarea rows="20" cols="30" style="width: 100%;" id="textwrite" name="content"><%=detailInfo.getContent()%>
								</textarea>
							</td>
						</tr>
					</table>
					...
					<div class="writebtn">
						<div class="wb1">
							<a href="" class="reg">
								<span><input type="submit" name="writeBtn" value="수정" class="submitBtn"/></span>
							</a>
							<a href="FcController?command=socialBoardDetail&bno=<%=detailInfo.getBno()%>" class="cancle">
								<span>취소</span>
							</a>
						</div>
					</div>
