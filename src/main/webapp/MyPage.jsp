			...
			<section class = "mainSection">
				<div class = "myInfo">
					<div class = "infoTop">
						...
						<dl>
							<dt>로그인 횟수</dt>
							<dd><span>${number_of_login}</span>회</dd>
						</dl>
					</div>
					<div class="btn_mypage">
			         <a href="FcController?command=memberCheckUpdate">회원정보 수정</a>
			         <a href="/mypage/mypage_gs_join">GS스포츠 통합회원 가입하기</a>
			         <a href="FcController?command=memberCheckSecession">회원탈퇴</a>
			       </div>
				</div>
				<div class = "myPageTab">
					<ul class = "menuTab">
						<li class = "active"><a href = "myPage1.html">티켓 예매</a></li>
						<li class = "null"><a>시즌 티켓</a></li>
						<li class = "null"><a>FC서울 멤버십</a></li>
						<li><a href = "myPage2.html">쿠폰 보관함</a></li>
						<li><a href = "myPage3.html">나의 Q&A 내역</a></li>
						<li class = "null"><a>SHOP 주문내역</a></li>
					</ul>
				</div>
				<div class = "myPage1">
					<div class = "title">티켓 예매 내역</div>
					...
					<div class = btn>
						<a href="javascript:ticketReserved();" class="btn_booking">입장권 예매</a>
						<a href="javascript:ticketCancle();" class="btn_cancel">입장권 취소</a>
					</div>
				</div>
			</section>
			</div>
