	...
	<section class="bannertop">
						...
						<ul>
							...
							<li>
								...
								<ul id="buttonUI" class = button123 style="display: none;">
									<li><a href="FcController?command=news">MEDIA</a>
									</li>
									<li><a
		...
		<div class="mainSection">
			...
			<section class = "teamTab">
				<ul>
					<li id = "FW"><a href = "FcController?command=teamMember&position=FW">FW</a></li>
					<li id = "MF"><a href = "FcController?command=teamMember&position=MF">MF</a></li>
					<li id = "DF"><a href = "FcController?command=teamMember&position=DF">DF</a></li>
					<li id = "GK"><a href = "FcController?command=teamMember&position=GK">GK</a></li>
					<li><a class = "none" onclick="ready()">군 입대 및 임대</a></li>
					<li><a class = "none" onclick="ready()">코칭스태프</a></li>
					<li><a class = "none" onclick="ready()">메디컬스태프</a></li>
					<li><a class = "none" onclick="ready()">지원스태프</a></li>
				</ul>
			</section>
