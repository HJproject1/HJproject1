...
<!-- 		</section> -->
	<div class="wrapper">
		<div class="subMain">
			...
			<section>
				...
				<form action="">
					<div class="sub1">
						<h4>
							본인인증
							<span>회원 가입여부 및 개인정보 보호를 위한 본인인증 절차가 필요합니다.</span>
						</h4>
						<div class="seWrap">
							<div class="left">
								<div class="ph">
									<p>휴대폰으로 인증</p>
									<p>
										<span>휴대폰 인증</span>을 통하여 본인인증을 합니다.
									</p>
									<p>
										<a href="#" id="PhoneAuth">휴대폰으로 인증받기</a>
									</p>
								</div>
							</div>
							<div class="right">
								<div class="ipin">
									<p>아이핀(I-pin)으로 인증</p>
									<p>
										<span>아이핀 인증</span>을 통하여 본인인증을 합니다.
									</p>
									<p>
										<a href="">아이핀으로 인증받기</a>
									</p>
						...
						<script>
		  // 버튼 클릭 시 팝업 창 띄우기
		  document.getElementById("PhoneAuth").addEventListener("click", function(event) {
		  ...
		  // 팝업 창 열기
		  function openPopup() {
		    var url = "Join2popup.jsp"; // 팝업으로 표시할 JSP 파일 경로
		    var width = 450;
		    var height = 600;
		    ...
		    window.open(url, "인증 팝업", options);
		  }
	</script>
						<div class="em">
	              			  본인인증을 위해 입력하신 개인정보는 본인인증기관에서 수집하는 정보이며, 이때 수집된 정보는 본인인증 외 어떠한 용도로도 이용되거나 별도 저장되지 않습니다.
						</div>
					</div>
				</form>
			</section>
