...
<head>
	...
	<link rel="stylesheet" href="css/EShopNotice.css">
	<script>
		function openBtn() {
		...
		<div class="mypage_content_wrap">
			<div class="mypage_content_box">
				...
				<div class="upper_content">
					<table width="100%">
						<tbody>
							<tr>
								<td class="sub_t1">
									Home > 고객센터 >  
									<span class="sub_t2">공지사항</span>
								</td>
							</tr>
							<tr>
								<td class="upperpage_title">
									<img src="https://www.fcseoul.com/resources/shop/_img/customer/title_notice.gif"/>
					...
					<div class="br15"></div>
					<table width="100%" class="notice_search_wrap">
						<tbody>
							<tr>
								<td>
									<div class="notice_search_box">
										...
										<input type="text" name="noticeSearch"/>
										<a>
					...
					<table width="100%" class="content_title_box2">
						...
						<tbody>
							...
							<tr>
								<td colspan="4"><br/><br/>게시물이 존재하지 않습니다.<br/><br/></td>
							</tr>
						</tbody>
					</table>
					<div class="br20"></div>
