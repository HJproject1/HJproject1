...
//  다른 방식 선언
// 	ArrayList<?> list1 = (ArrayList<?>)request.getAttribute("photoList");
// 	ArrayList<PhotoDTO> photoList = new ArrayList<PhotoDTO>(); 
// 	for(Object obj : list1){
// 		if(obj instanceof PhotoDTO){
// 			photoList.add((PhotoDTO)obj);
// 		}
// 	}
...
<head>
	...
	<link rel="stylesheet" href="css/photoDetail.css">
    ...
    document.getElementById('download').addEventListener('click', function() {
      // 이미지 URL
      var imageUrl = 'https://files.fcseoul.com/data03/img_lrg/1681683674599_b.JPG';
    ...
    function downloadImage(url) {
      ...
      link.href = url;
      link.download = 'image.jpg'; // 다운로드될 파일명 설정
						...
						<ul>
							...
							<li>
								...
								<ul id="buttonUI2" class = button123 style="display: none;">
									...
									<li><a href="Notice.jsp">NOTICE</a>
									</li>
									<li><a href="Photo.jsp">PHOTO</a>
								</ul>
							</li>
						</ul>
					</div>
	...
	<div class="submain">
		...
		<section>
			<div class="btDatilWrap">
				...
				<div class="btnWrap">
					<a class="bg" href="FcController?command=photo&page=<%=pageNum%>">목록</a>
				</div>
			</div>
		</section>
			<div class="plwrap">
				...
				%>
					...
					<li><a href="FcController?command=photoDetail&bno=<%=bno%>">
							<div class="imgwrap">
								<img
									src="<%=img%>">
							</div>
