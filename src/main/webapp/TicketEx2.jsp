...
<head>											
	...
	<script>		
	    ...
	    const egBtn = document.getElementById("egBtn");
	    let clickArr = [];
	    img.src =
	    ...
	    egBtn.addEventListener("click", drawClick);
				...
				<div class="reserve_right">							
					...
					<div class="reserve_artbx">						
						...
						<ul class="seat_lst">			
							<li id="egBtn">				
								<a  class="zero select">			
									<span class="seat_color" style="background:red"></span>		
									<div class="seat_detail_info">		
										<span class="seat_grade">동측 G구역</span>	
										<span class="seat">	
											<span class=""><%=jsonArray.size()-jsonArrayNull.size()%></span>
											<span class="">석</span>
										</span>	
									</div>		
								</a>			
