...
<%=request.getAttribute("MemberSecessionMsg") == null ? "" : request.getAttribute("MemberSecessionMsg")%>
...
<script> 
    ...
    <script>
		$(function(){
    		$("#naver_id_login").children().children("img").css("display", "none");
		});    
    </script>
</head>
<body>
	...
	<div class="subMain">
		...
		<section>
			<div class="subTop">
				<p>
					<span class="point">FC서울 공식 웹사이트</span>
					에 오신 것을 환영합니다.
				</p>
				<p>
					항상 새로운 서비스를 위해 노력하고 있는 fcseoul.com 회원으로 가입하시면
					<br/>
					FC서울이 제공하는 다양한 서비스를 제공받으실 수 있습니다.
				</p>
			</div>
				<input type="hidden">
				<div class="login">
...
<!-- 								<button type="submit">로그인</button> -->
						...
						<div class="qBox">
							<div class="leftBox">
								...
								<div class="btnWrap">
									<a href="FcController?command=join1">회원가입</a>
								</div>
							</div>
							<div class="rightBox">
								<p>
								...
								<div class="btnWrap">
									<a href="https://www.fcseoul.com/member/idFindForm">아이디/비밀번호 찾기</a>
								</div>
					...
					<ul class="snsWrap">
						<li>
							<a href="https://www.facebook.com/login.php?skip_api_login=1&api_key=1366977756981039&kid_directed_site=0&app_id=1366977756981039&signed_next=1&next=https%3A%2F%2Fwww.facebook.com%2Fv7.0%2Fdialog%2Foauth%3Fclient_id%3D1366977756981039%26redirect_uri%3Dhttps%253A%252F%252Fwww.fcseoul.com%252Flogin%252FfacebookLoginCheck%26state%3D708053400567086479104555132571831421916%26ret%3Dlogin%26fbapp_pres%3D0%26logger_id%3D0e9c3bc6-871c-4de1-a6b7-1b3d0a469ebd%26tp%3Dunspecified&cancel_url=https%3A%2F%2Fwww.fcseoul.com%2Flogin%2FfacebookLoginCheck%3Ferror%3Daccess_denied%26error_code%3D200%26error_description%3DPermissions%2Berror%26error_reason%3Duser_denied%26state%3D708053400567086479104555132571831421916%23_%3D_&display=page&locale=ko_KR&pl_dbl=0">
								페이스북 로그인
							</a>
						</li>
						<li>
						...
						<li>
							<a href="https://accounts.kakao.com/login/?continue=https%3A%2F%2Fkauth.kakao.com%2Foauth%2Fauthorize%3Fresponse_type%3Dcode%26redirect_uri%3Dhttps%253A%252F%252Fwww.fcseoul.com%252Flogin%252FkakaoLoginCheck%26through_account%3Dtrue%26client_id%3D3012b5c1346d380847b706dd445f1de9#login">
								카카오톡 로그인
							</a>
						</li>
					</ul>
...
s					<div class="pri2">
   	...
   	<script type="text/javascript">
	  	...
	  	naver_id_login.setDomain("http://localhost:5050");
