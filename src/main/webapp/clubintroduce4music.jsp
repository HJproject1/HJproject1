...
<head>
	...
	<link rel="stylesheet" href="css/clubintro4music.css">
...
<body>
	...
	<section class="bannertop">
		...
		<div class="mainSection">
			...
			<div class="song">
				<strong>응원가</strong>
				<p>FC서울 경기를 더욱 신나게 하는 응원가를 소개합니다.</p>	
			</div>
			<div class="songlist">
				<ul>
					<li>
						<span>클럽송</span>
						<strong>우리의 서울</strong>
						<p>나상현씨밴드</p>
						<div class="musicbox">
							<div class="listen">듣기</div>
							<div class="download">다운로드</div>
							<div class="songtext">가사</div>
						</div>
					</li>
					<li>
						<span>클럽송</span>
			...
			<div class="sociallast">
				<div class="numpage">
					<a href=""></a>
					<a class="pnum page" href="">1</a>
					<a class="pnum" href="">2</a>
					<a class="pnum" href="">3</a>
					<a class="pnum" href="">4</a>
					<a class="pnum" href="">5</a>
					<a class="pnum" href="">6</a>
					<a class="pnum" href="">7</a>
					<a class="pnum" href="">8</a>
					<a class="pnum" href="">9</a>
					<a class="pnum" href="">10</a>
					<a href=""></a>
				</div>
			</div>
		</div>
