...
<head>
	...
	<link rel="stylesheet" href="css/join4.css">
		...
		<div class="subMain">
					...
					<li>
						...
						<div class="jsLast">
							<div class="jsBefore" style="border-top-color: rgb(199, 1, 1);
							    border-bottom-color: rgb(199, 1, 1);">
							</div>
							<div class="jsAfter"></div>
						</div>
					</li>
			...
			<div class="jcWrap">
				<div class="jcTop">
					...
					<p>
						FC서울 웹사이트 회원가입을 
						<i class="point">축하합니다!</i>
					</p>
					<p>FC서울 회원가입이 완료되었습니다.</p>
				</div>
...
<!-- 				<div class="tblBottomWrap"> -->
<!-- 					<p>개인정보 보호를 위하여 아이디 끝 세 자리 *처리 / 비밀번호 앞 두 자리 제외한 나머지 *처리</p> -->
<!-- 				</div> -->
				<div class="btnWrap" style="margin-top: 60px;">
					<a href="FcController?command=login" class="bp">확인</a>
				</div>
		    </div>
		</div>
