...
<head>
	...
	<link rel="stylesheet" href="css/clubintro4suport.css">
...
<body>
	...
	<section class="bannertop">
		...
		<div class="mainSection">
			...
			<div>
				<ul class="info">
					<li><a href="FcController?command=clubIntro4">응원존</a></li>
					<li><a href="FcController?command=clubIntro4Music">응원가</a></li>
					<li class="active"><a>서포터즈</a></li>
				</ul>
			</div>
			<div class="suho">
				<strong class="one">FC서울 <span>12번째 전사</span> 수호신!</strong> <br>
				<strong class="one2">신나는 응원가, 화려한 카드섹션, 바람결에 펄럭이는 깃발, 승리를 자축하는 뒷풀이까지.. <br>
FC서울을 지지하는 수호신은 <span> '그대들이 가는 길 우리가 지켜주리라'</span>라는 걸개의 문구처럼 FC서울과 함께 한결같이 늘 같은 길을 걸어오고 있습니다.</strong>
				<p>그라운드를 누비는 FC서울의 전사들처럼 더욱 열정적이고 싶다면 주저없이 당신에게 권해드립니다. ‘FC서울 서포터즈 지지자연대 수호신’은 <br>
FC서울을 응원하는 당신과 늘 함께할 준비가 되어 있습니다.</p>
				<div class="go">
					<a href="">수호신 둘러보기/가입하기</a>
				</div>
			</div>
			<img class="suimg" alt="" src="	https://www.fcseoul.com/resources/front/images/sub/club/img_supporters.jpg">
