...
<head>
	...
	<link rel="stylesheet" href="css/clubintro5.css">
...
<body>
	...
	<section class="bannertop">
		...
		<div class="mainSection">
			...
			<div>
				<img alt="" src="	https://www.fcseoul.com/resources/front/images/sub/club/img_mascot.jpg">
				<div class="downbtn">
			...
			<table>
				<tr class="second">
					<th>탄생배경</th>
					<td>
						<p>불타는 태양의 운석에서 폭발하여 깨어나옴</p>
						<p>2004년 1월 1일. 태양의 폭발과 함께 뿜어져 나온 뜨거운 태양운석이 태양계를 거침없이 돌다가 2004년 4월 3일, 우주행성 가운데 지구의 대한민국 서울, 서울월드컵경기장으로 돌진하면서 그의 탄생은 시작된다.</p>
						<p>그의 태양에서 출발한 생명체로써 곧 태양의 아들이며 이는 FC서울의 엠블럼에 새겨진 태양수호신의 아들을 뜻한다.</p>
						<p>태양수호신의 부름으로 일찍이 이글거리는 태양의 폭발이 있었고 뜨거운 태양운석 속에서 태양계를 거침없이 휘도는 4개월의 여정 속에서 초우주적인 초능력의 기를 받아 2004년 4월 3일, 비로소 태양수호신의 부름으로 FC서울의 개막전이 열리는 지구의 대한민국 서울월드컵경기장으로 돌진하며 그의 진가를 드러내기 시작한다.</p>
						<p>그의 능력은 깨어나는 순간, 상황에 처해진 것에 초능력을 받게 되어 있었으므로 FC서울을 대표하는 상징적인 존재로 시작되었다.</p>
						<p>이미 우주에서 받아진 그이 모든 능력은 운석알에서 깨어남과 동시에 축구의 신비한 존재됨과 동시에 서울월드컵경기장 관중의 어마 어마한 함성의 기가 함께 더해짐으로 또 다른 인간의 심적, 정신적 능력을 부여받게 됨으로 인해 FC서울의 한 가족으로의 탄생하게 되는 것이다.</p>
						<p>축구 귀재로서의 능력과 함께 강인하고 유연성있는 몸과 지적인 사고를 바탕으로 하는 두뇌, 그 이상의 것을 가진 초능력과 인간과 축구사랑을 아는 인간적 감성..이 모든것이 2004년 4월 3일, FC서울의 홈 구장인 서울월드컵경기장에서 그의 출정을 알리게 된다.</p>
					</td>
				</tr>
				<tr>
					<th>성격</th>
					<td>
						언제 어디서건 굴하지 않는 당당한 성격의 소유 <br>
						미소와 함께 신중함을 잃지 않는 강인한 성격을 소유<br>
						겁없는 승부욕과 함께 강자에겐 강하게 약자에겐 배려심을 발휘하는 따뜻함을 소유
					</td>
				</tr>
			</table>
