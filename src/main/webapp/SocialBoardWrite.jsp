...
<%
    	SocialBoardDto name = (SocialBoardDto)request.getAttribute("name");
...
<%-- 					<input type="hidden" name="id" value="<%=id %>"/> --%>
					...
					<table>
						...
						<tr>
							<th>내용</th>
							<td>
								<textarea rows="20" cols="30" style="width: 100%;" id="textwrite" name="content">
								</textarea>
							</td>
						</tr>
					</table>
					...
					<div class="writebtn">
						<div class="wb1">
							<a href="" class="reg">
								<span><input type="submit" name="writeBtn" value="등록" class="submitBtn"/></span>
							</a>
							<a href="" class="cancle">
								<span>취소</span>
							</a>
