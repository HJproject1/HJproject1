	...
	$('html').click(function(e) {
		if($(e.target).hasClass("button")) {
			if ($(e.target).parent().find(".button123").css("display") == "none") {
				...
				$(e.target).parent().find(".button123").css("disp lay","block");
...
<body>
	...
	<section class="bannertop">
		...
		<div class="mainSection">
			...
			<div class="writewrap">
				<form action="writeAction.jsp" encType = "multipart/form-data" id="firm" method="post">
					<table>
						<tr>
							<th>제목</th>
							<td>
						...
						<tr>
							<th>내용</th>
							<td>
								<textarea rows="20" cols="30" style="width: 100%;" id="textwrite" name = "textContent" required>
								</textarea>
							</td>
						</tr>
						<tr>
							<th>이미지</th>
							<td>
								<input type="file" class="real-upload" accept="image/*" name = "fileName" id = "fileName" required>
							</td>
						</tr>
					</table>
					...
					<div class="writebtn">
						<div class="wb1">
							<input type = "submit" class="reg" value = "등록" id = "send">
							<a onclick = "history.back()"class="cancle">
								<span>취소</span>
							</a>
						</div>
					</div>
