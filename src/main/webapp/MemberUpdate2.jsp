...
<head>
	...
	<link rel="stylesheet" href="css/memberUpdate2.css">
	...
	<script>
		...
		$(function(){
			...
			nick_name = $("#nick_name").val();
			    ...
			    $.ajax({
			        type: "POST",
			        url: "./UserRegisterNickCheckServlet",
...
<!-- 		</section> -->
	<div class="wrapper">
		<div class="subMain">
			...
			<input type="hidden" name="command" value="memberUpdatePage"/>
				<div class="sub1">
					<div class="hs">
						<h4>회원정보 수정</h4>
					</div>
					<div class="hs2">
						<span>
							회원님의 정보 중 변경된 내용이 있을 경우 수정해주세요. 회원정보는 개인정보처리방침에 따라 안전하게 보호되며, 회원님의 동의 없이 공개 또는 제3자에게 제공되지 않습니다.
						</span>
					</div>
					<div class="tblWrap row">
						<table>
							...
							<tr>
								...
								<td class="tbl_pb">
									<span>
										<input type="password" name="pass" id="pass" maxlength="15" value="${pass}"/>
										<i id="showPassword"></i>
									</span>
							...
							<tr>
								...
								<td>
									<span>
										<input type="password" name="pass2" id="pass2" maxlength="15" value="${pass}"/>
							...
							<tr>
								...
								<td>
									<span>
										<input type="text" name="nick_name" id="nick_name" maxlength="10" value="<%=dto.getNick_name()%>"/>
									</span>
									<span>
							...
							<tr>
								...
								<td class="phone">
									...
									<span>
										<input class="newPhone" type="text" name="phone" value="${phone}"/>
									</span>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td>
									<div>
										<span>
											<input type="text" id="postal_code" name="postal_code" value="${postal_code}" readonly/>
										</span>
										<span>
									...
									<div>
										<span>
											<input type="text" name="address" maxlength="50" value="${address}"/>
										</span>
									</div>
								</td>
							</tr>
				...
				<div class="btnWrap">
					<input type="submit" class="bp" value="확인"/>
					<button type="button" class="bg" onclick="goBack()">취소</button>
				</div>
			</form>
		</div>
