...
<%=request.getAttribute("UpdateErrMsg") == null ? "" : request.getAttribute("UpdateErrMsg")%>
<%
		...
		<section class="top">
			...
			<div class="contentWrap">
				...
				<div class="modi_info02">
					...
					<input type="hidden" name="command" value="memberPass"/>
						<dl>
							<dt>아이디</dt>
							<dd>${id}</dd>
							<dt>
						...
						<p>
							외부로부터 회원님의 정보를 안전하게 보호하기 위해 비밀번호를 다시 한 번 확인 합니다.
							<br/>
