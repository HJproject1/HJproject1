...
public class SocialWriteAction implements Action{
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		SocialBoardDao nameDao = new SocialBoardDao();
		SocialBoardDto name = nameDao.nameNickName(id);
		...
		RequestDispatcher rd = request.getRequestDispatcher("SocialBoardWrite.jsp");
