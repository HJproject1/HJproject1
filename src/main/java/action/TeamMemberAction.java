...
import dto.RankDto;
import teamMember.teamMemberDAO;

public class TeamMemberAction implements Action {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("teamMember.jsp?"+position).forward(request, response);
	}
