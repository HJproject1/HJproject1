...
public class SocialBoardDetailAction implements Action{
...
//		int pageNum = (int)session.getAttribute("page");
		...
		request.setAttribute("sbDetail", sbDetail);
		request.setAttribute("sbComment", sbComment);
		
		
		RequestDispatcher rd = request.getRequestDispatcher("SocialBoardDetail.jsp");
