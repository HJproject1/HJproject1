...
public class MatchInfoAction implements Action {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			mDTO1arr = MID2.MatchByDate(informationDate,Month,Year);
		} catch (Exception e) {
		...
		request.getRequestDispatcher("MatchInfoV2.jsp").forward(request,  response);
	}
